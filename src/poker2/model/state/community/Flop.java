...
public class Flop extends CommunityState
{

	public Flop(PokerModel model)
	{
		super(model, 0);
	...
	public boolean bet(String name, String action, int bet)
	{
		...
		if (super.isWinner() || super.isRoundDone(new Turn(this.model), curPlayer))
			return true;
		return true;
	}
	...
	{
		this.model.getView().drawFlop(model);
	}
