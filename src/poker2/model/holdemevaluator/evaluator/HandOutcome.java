...
public final class HandOutcome implements Comparable<HandOutcome>
{
	...
	{
		return "HandOutcome{" + "handName=" + handName + ", topCards=" + Arrays.toString(topCards) + '}';
	}
	...
	public int compareTo(final HandOutcome o)
	{
		...
		Arrays.sort(myTopCards, Collections.reverseOrder());
		Arrays.sort(otherTopCards, Collections.reverseOrder());
